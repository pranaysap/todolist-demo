...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Harness Sample To-Do List Sign in</title>
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span12">
					<br>
					<h1 class="text-center" style = "font-family:new courier;color:black;font-size:34px;">Harness Sample To-Do List</h1><hr><br>
				</div>
			...
			<div class="row">
				...
				<div class="span4 offset8">
					<blockquote class="pull-right">
						<h3 class="text-center">GET SHIP DONE.</h3>
